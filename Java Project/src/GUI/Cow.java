    ...
    ImageIcon cow = new ImageIcon("cow.png");
     ...
     public Cow(){
        ...
        label2.setText("My Guess Is...\n COW!!!");
         ...
         label4.setText("Type : Herbivorous Name : cow | Attribute : Strong hooves | Habitat : Grasslands, meadows, and plains");

         label5.setBounds(10,220,600,300);
         label5.setFont(new Font("MV Boli",Font.TRUETYPE_FONT,15));
         label5.setText(" Size : 110 | Movement : walking,trotting,galloping | Speed : Moderate");
