...
public class Deer extends JFrame {
    ...
    ImageIcon cow = new ImageIcon("deer.png");
     ...
     public Deer(){
        ...
        label2.setText("My Guess Is...\n DEER!!!");
         ...
         label4.setText("Type : Herbivorous Name : Deer | Attribute : Antler | Habitat : Forests, woodlands, and grasslands");
