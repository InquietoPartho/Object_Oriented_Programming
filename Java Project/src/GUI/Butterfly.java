...
public class Butterfly extends JFrame {
    ...
    ImageIcon cow = new ImageIcon("butterfly.png");
     ...
     public Butterfly(){
        ...
        label2.setBounds(260,200,400,100);
        label2.setFont(new Font("MV Boli",Font.BOLD,20));
        label2.setText("My Guess Is...\n BUTTERFLY!!!");

         label4.setBounds(50,200,800,300);
         label4.setFont(new Font("MV Boli",Font.TRUETYPE_FONT,15));
         label4.setText("Type : Insect Name : Butterfly | Attribute : Metamorphsis | Habitat : Meadows & grassland");

         /*

         label5.setBounds(10,220,600,300);
         label5.setFont(new Font("MV Boli",Font.TRUETYPE_FONT,15));
         label5.setText(" Size : 1100 | Movement : walking,trotting,galloping | Speed : Moderate");
*/
